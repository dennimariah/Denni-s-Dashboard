...
const HAIR_LOLA = [
  ...
  },
  {
    ...
    tagTone: 'peach',
    desc: 'Smoothing mask aligns the hair fiber and reduces frizz by up to 40%. Use as your DC on weeks you\'re flat-ironing.',
    howto: [
  ...
  },
  {
    ...
    tag: 'SCALP GROWTH',
    tagTone: 'sun',
    desc: 'Leave-on growth tonic with Jaborandi, Rosemary, Caffeine, Ginkgo, Nettle, Ginger. One of the strongest natural growth formulas.',
    howto: [
