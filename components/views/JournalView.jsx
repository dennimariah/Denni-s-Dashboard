      ...
      <div className="page-head">
        <div>
          ...
          <div className="page-head__date mt-sm">
            ...
            {journal[0] ? ` · most recent ${journal[0].date}` : ''}
          </div>
        </div>
      ...
      <div className="bento">
        <div className="col-8">
          ...
          <div style={{ marginTop: 22 }}>
            ...
            {journal.length === 0 && (
              <div className="empty" style={{ padding: 40 }}>No entries yet — write your first one above</div>
            )}
            {journal.map((e) => (
        ...
        <div className="col-4">
          <div className="card card--pink">
            ...
            <div className="mt-md text-soft fs-sm" style={{ lineHeight: 1.55 }}>
              Track your daily mood to see your emotional weather patterns over time.
            </div>
          </div>
          ...
          <div className="card card--mint mt-md">
            ...
            <div className="col gap-sm">
              <div className="row row--between">
                ...
                <Pill tone="mint" mono>{journal.length}</Pill>
              </div>
              <div className="row row--between">
