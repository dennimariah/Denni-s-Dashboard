...
import { cls, pct, currency, TRANSACTION_ICONS } from '@/lib/helpers';
import { CardHead, Bar, Pill, burstConfetti } from '@/components/ui/primitives';
import Icon from '@/components/ui/Icon';

function TransactionModal({ editing, budget, onSave, onDelete, onClose }) {
...
export default function FinanceView({ state, setState }) {
  ...
  const totalLimit = cards.reduce((s, c) => s + (c.limit || 1), 0);
  ...
  return (
    <>
      <div className="page-head">
        <div>
          <div className="page-head__greeting">Finance · {monthLabel}</div>
      ...
      <div className="bento">
        ...
        {/* Savings goals */}
        {savings.length > 0 && (
          <div className={cls('card', cards.length > 0 ? 'col-5' : 'col-6')}>
            <CardHead
              title="Savings goals"
        ...
        <div className="card col-4">
          <CardHead
            ...
            right={
              <button className="btn btn--icon" onClick={() => { setEditingTx(null); setTxOpen(true); }}>
